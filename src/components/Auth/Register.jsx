            ...
            >
                ...
                <Form
                    ...
                    >
                        ...
                        <Form.Group className="mb-4 mt-4" controlId="nameId">
                            <Form.Control
                                onChange={handleOnChange}
                                id='name' className="bg-lightgray border-0" name='name' placeholder="Name" type="text" />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-4 mt-4" controlId='passwordId'>
                            <Form.Control
                                onChange={handleOnChange}
