...
import bummi from "../assets/bummi.gif"
        ...
        <>
            ...
            <div className='d-flex justify-content-between' style={{ position: "absolute", width: "100%" }} >
                ...
                <div>
                    ...
                    <h1 className="display-4 mt-1" style={{color:"DarkOrange"}}>
                        Waysbook Store</h1>
                        <h3>Pusat Buku Terbesar Didunia <img src={bummi} alt="" /> </h3>
                        ...
                        <h1 style={{color:"red"}}>Gratis Ongkir!</h1>
                        </JackInTheBox>
                ...
                <Container >
                    <p className='fw-bold text-start pb-3 fw-bold' style={{ fontFamily: "Times New Roman", fontSize: "25px", color: "palevioletred" }} > </p>
                    <Fade>
                        <Swiper
                            slidesPerView={2}
                            spaceBetween={30}
                                                    ...
                                                    <Card.Body >
                                                        ...
                                                        <div className=' justify-content-center mt-5'>
                                                            ...
                                                            <button
                                                                ...
                                                                className='px-5 bg-dark text-white border-0 py-1 ' >A to Cart</button>
                                                        </div>
                                                    </Card.Body>
                                                </div>
                                            </div>
